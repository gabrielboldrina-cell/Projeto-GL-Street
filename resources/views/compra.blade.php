...
<nav class="navbar navbar-expand-lg navbar-dark site-navbar" aria-label="Main navbar">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mainNavCompra"
                aria-controls="mainNavCompra" aria-expanded="false" aria-label="Abrir navegacao">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="mainNavCompra">
...
<div class="checkout-wrapper">
        <table>
            ...
            <tbody>
                <tr>
                    <td><label>Valor da Compra:</label></td>
                ...
                <tr>
                    <td colspan="2">
                        <button class="btn btn-sm btn-danger w-100" id="btncompra">Confirmar Pagamento</button>
                    </td>
                </tr>
            </tbody>
        </table>
