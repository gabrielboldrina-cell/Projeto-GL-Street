        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
                    ...
                    <li class="nav-item"><a class="nav-link site-nav-link nav-pill"
                            href="{{ route('cadastro') }}">Cadastra-se</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
@section('content')
                ...
                <div class="row g-4 align-items-end">
                    <div class="col-lg-7">
                        ...
                        <p class="hero-subtitle">
                            Conheça a GL Street, onde a paixão pelo futebol se encontra com a cultura urbana, Descubra a
                            nova coleção, inspirada na autenticidade das ruas e na emoção dos jogos. Camisas, tenis e
                            acessórios que combinam o melhor dos dois mundos para quem vive o futebol em cada passo.
                        </p>
                    ...
                    <div class="col-lg-5">
                        <aside class="drop-card" aria-label="Proximo destaque da loja">
                            ...
                            <ul class="drop-meta">
                                <li>EM BREVE</li>
                                <li>GL Street: não seguimos tendencias, a rua segue <strong>nossos passos</strong>. </li>
                            </ul>
    ...
    <footer class="site-footer text-center text-lg-start">
                ...
                <div class="row mt-3">
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        <h6 class="text-uppercase fw-bold mb-4">
                            <i class="fas fa-gem me-3"></i>Um pouco sobre nós </h6>
                        <p>
                            A GL Street nasceu da paixão pelo futebol e pela cultura urbana, trazendo para as ruas a energia
                            dos estádios. Nossa missão é criar produtos que unam estilo, conforto e autenticidade, inspirados
                            na diversidade das ruas e na emoção dos jogos.
                        </p>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-print me-3"></i> 18 1234-3145</p>
                    </div>
                    <!-- Grid column -->
                </div>
                <!-- Grid row -->
        ...
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
            GL Street © 2026 - Todos os direitos reservados.
        </div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->
