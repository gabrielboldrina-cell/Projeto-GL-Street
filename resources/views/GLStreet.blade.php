    ...
    <section class="hero-section">
        ...
        <div class="container hero-content">
            <div class="row g-4 align-items-end">
                <div class="col-lg-7">
                    <p class="hero-kicker">Cole��o 2026</p>
                    <h1 class="hero-title">A energia do estadio, o estilo da rua.</h1>
                    <p class="hero-subtitle">
                       Conhe�a a GL Street, onde a paix�o pelo futebol se encontra com a cultura urbana, Descubra a nova cole��o, inspirada na autenticidade das ruas e na emo��o dos jogos. Camisas, tenis e acess�rios que combinam o melhor dos dois mundos para quem vive o futebol em cada passo.
                    </p>
                ...
                <div class="col-lg-5">
                    <aside class="drop-card" aria-label="Proximo destaque da loja">
                        ...
                        <ul class="drop-meta">
                            <li>EM BREVE</li>
                            <li>GL Street: n�o seguimos tend�ncias, a rua segue <strong>nossos passos</strong>.  </li>
                        </ul>
