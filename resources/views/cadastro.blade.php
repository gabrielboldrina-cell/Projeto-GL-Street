    ...
    <nav class="navbar navbar-expand-lg navbar-dark site-navbar" aria-label="Main navbar">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                data-bs-target="#mainNavCadastro" aria-controls="mainNavCadastro"
    ...
    <div class="page-wrap">
        <div class="register-card">
            ...
            <div class="form-grid">
                <div class="gl-field span-full">
                    ...
                    <div class="gl-input-wrap">
                        ...
                        <input class="gl-input" type="text" id="nomeCompleto" placeholder="Gabriel Oliveira" autocomplete="name">
                    </div>
                </div>
                ...
                <div class="gl-field span-full">
                    ...
                    <div class="gl-input-wrap">
                        ...
                        <input class="gl-input" type="email" id="email" placeholder="seu@email.com" autocomplete="email">
                    </div>
                </div>
                ...
                <div class="gl-field">
                    ...
                    <div class="gl-input-wrap">
                        ...
                        <input class="gl-input" type="text" id="usuario" placeholder="gabriel_gl" autocomplete="username">
                    </div>
                </div>
                ...
                <div class="gl-field">
                    ...
                    <div class="gl-input-wrap">
                        <span class="gl-input-icon">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.14 12a19.79 19.79 0 0 1-3-8.57 2 2 0 0 1 1.99-2.18h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L7.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
                        </span>
                        <input class="gl-input" type="tel" id="telefone" placeholder="(11) 99999-9999" autocomplete="tel">
                    </div>
                </div>
                ...
                <div class="gl-field span-full">
                    ...
                    <div class="gl-input-wrap">
                        ...
                        <input class="gl-input" type="text" id="cpf" placeholder="000.000.000-00" maxlength="14" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="gl-field span-full">
                    ...
                    <div class="gl-input-wrap">
                        ...
                        <input class="gl-input with-eye" type="password" id="senha" placeholder="Minimo 8 caracteres" autocomplete="new-password">
                        <button class="gl-eye-btn" type="button" onclick="togglePass('senha', this)" aria-label="Mostrar senha">
                ...
                <div class="gl-field span-full">
                    ...
                    <div class="gl-input-wrap">
                        ...
                        <input class="gl-input with-eye" type="password" id="confirmarSenha" placeholder="Repita a senha" autocomplete="new-password">
                        <button class="gl-eye-btn" type="button" onclick="togglePass('confirmarSenha', this)" aria-label="Mostrar confirmacao">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" /></svg>
                        </button>
                    </div>
                </div>
            ...
            <div class="terms-note">
                ...
                <label for="termos">
                    Li e aceito os <a href="#">Termos de Uso</a> e a <a href="#">Politica de Privacidade</a> da GL Street.
                </label>
            </div>
